	...
	TSkillExecutor: Schedule<SkillBehaviorConfig> + Flush,
{
	...
	{
		facing.override_face(Face::SkillTarget);
	}
...
mod tests {
	...
	#[test_case(StateMeta::Entering; "begin")]
	#[test_case(StateMeta::In; "continuation")]
	fn apply_skill_target_facing_on_aim(
