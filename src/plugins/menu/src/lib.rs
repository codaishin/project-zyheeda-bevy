...
use common::{
	...
	traits::{
		...
		handles_input::{HandlesInput, HandlesInputMut, InputSystemParam},
	...
	TLoadout: ThreadSafe + HandlesLoadout,
{
	...
	fn state_control(&self, app: &mut App) {
		...
		app.add_systems(
			...
			(
				...
				set_state_from_input::<GameState, MenuState, InputSystemParam<TInput>>
	...
	fn ui_overlay(&self, app: &mut App) {
		...
		// 	.add_observer(QuickbarPanel::add_quickbar_primer::<TInput::TKeyMap>)
		// 	.add_systems(
		// 		Update,
		// 		(
		// 			QuickbarPanel::set_icon::<TPlayers::TPlayer, TLoadout::TSlots>,
		// 			QuickbarPanel::set_color::<TPlayers::TPlayer, TInput::TKeyMap, TLoadout::TSlots>,
	...
	fn settings_screen(&self, app: &mut App) {
		...
		app.register_required_components::<KeyBindInput, Interaction>()
			...
			.add_systems(
				Update,
				(
					// SettingsScreen::set_key_bindings_from::<TInput::TKeyMap>,
					...
					// KeyRebindInput::rebind_apply::<TInput::TKeyMap>,
				)
	...
	fn general_systems(&self, app: &mut App) {
		...
		// let input_label_icons = InputLabel::icon::<TInput::TKeyMap>;
