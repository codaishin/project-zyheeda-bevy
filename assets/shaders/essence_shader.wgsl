...
@group(#{MATERIAL_BIND_GROUP}) @binding(2) var<uniform> shine_color: vec4<f32>;
@group(#{MATERIAL_BIND_GROUP}) @binding(3) var material_color_texture: texture_2d<f32>;
@group(#{MATERIAL_BIND_GROUP}) @binding(4) var material_color_sampler: sampler;
